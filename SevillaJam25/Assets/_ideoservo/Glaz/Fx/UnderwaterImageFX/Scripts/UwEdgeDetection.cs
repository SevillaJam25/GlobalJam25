...
{
    [ExecuteInEditMode]
    [AddComponentMenu ("GlazUnderwaterFX/Edge Detection")]
    public class UwEdgeDetection : UwPostEffectsBase
    {
        // Underwater params
        // Default settings are good - To be combined with Blur Effect
