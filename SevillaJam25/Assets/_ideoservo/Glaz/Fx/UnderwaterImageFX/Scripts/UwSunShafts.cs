...
{
    //[ExecuteInEditMode]
    [AddComponentMenu ("GlazUnderwaterFX/Sun Shafts")]
    public class UwSunShafts : UwPostEffectsBase
    {
        ...
        public int radialBlurIterations = 3;
        public Color sunColor = Color.white;
        public Color sunThreshold = new Color(0.87f, 0.74f, 0.65f);
        public float sunShaftBlurRadius = 2.0f;
        public float sunShaftIntensity = 2.0f;
